...
parser.add_argument( "-r1", "--r1", default = "r_TTTT" )
parser.add_argument( "-r2", "--r2", default = "r_SIG" )
...
x, y, deltaNLL = [], [], []
for ev in t:
    x.append( getattr(ev,args.r1) )
    y.append( getattr(ev,args.r2) )
...
canv.Update()
canv.SaveAs("multiDimFit_2DNLL_scan.png")
os.system( "cp multiDimFit_2DNLL_scan.png {}".format( args.html ) )
