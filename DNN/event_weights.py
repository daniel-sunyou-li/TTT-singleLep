...
for sample in config.sig_training[ year ]: # + config.bkg_training[ year ]:
  ...
  rDF_filt = rDF.Filter( "( isTraining == 1 || isTraining == 2 ) && DataPastTriggerX == 1 && MCPastTriggerX == 1 && ( isElectron == 1 || isMuon == 1 ) && leptonPt_MultiLepCalc > 20 && NJetsCSV_JetSubCalc >= 2 && NJets_JetSubCalc >= 5 && AK4HT > 350 && corr_met_MultiLepCalc > 30 && minDR_lepJet > 0.4" )
