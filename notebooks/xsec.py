...
xsec = {
    "TTTJ_TuneCP5_13TeV-madgraph-pythia8_hadd.root": 0.0003974 * 1.75,
    "TTTW_TuneCP5_13TeV-madgraph-pythia8_hadd.root": 0.0007314 * 1.86,
...
genWeights = {
    "WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.978569,
    "WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.928054,
    "WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.856705,
    "WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.757463,
    "WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.608292,
    "WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8_hadd.root": 0.454246,
    "DYJetsToLL_M-50_HT-200to400_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.992853,
    "DYJetsToLL_M-50_HT-400to600_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.974071,
    "DYJetsToLL_M-50_HT-600to800_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.948367,
    "DYJetsToLL_M-50_HT-800to1200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.883340,
    "DYJetsToLL_M-50_HT-1200to2500_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.749894,
    "DYJetsToLL_M-50_HT-2500toInf_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8_hadd.root": 0.617254
}
...
for file in xsec:
    if "TTToSemiLeptonic" in file and "HT0Njet0_ttjj" in file:
        ...
        rTree = rFile.Get( "NumTrueHist" ).Clone( "NumTrueHist" )
        nTrueHist = rTree.Integral()
    if file in genWeights:
        norm[file] = lumi[year] * genWeights[file] * xsec[file] / nTrueHist
    else:
