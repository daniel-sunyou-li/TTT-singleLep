...
process.mcweightanalyzer = cms.EDAnalyzer(
    "WeightAnalyzer",
    overrideLHEweight = cms.bool( False ),
...
jetDir = {
  key: os.path.join( "TTT-singleLep/LJMet/data/", "Summer19UL17_{}".format( key ) ) for key in [ "MC", "DATA" ] 
}
...
JetSubCalc_cfg = cms.PSet(
  ...
  puppiCorrPath      = cms.FileInPath('TTT-singleLep/LJMet/data/PuppiSoftdropMassCorr/weights/puppiCorr.root'),
