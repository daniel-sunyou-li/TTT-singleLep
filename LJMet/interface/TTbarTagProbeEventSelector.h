#ifndef LJMet_interface_TTbarTagProbeEventSelector_h
#define LJMet_interface_TTbarTagProbeEventSelector_h

#include "TTT-singleLep/LJMet/interface/BaseEventSelector.h"
...
#include "TTT-singleLep/LJMet/interface/BTagSFUtil.h"


using namespace std;

class TTbarTagProbeEventSelector : public BaseEventSelector { //adapted from singleLepEventSelector.cc

public:


    TTbarTagProbeEventSelector();
    ~TTbarTagProbeEventSelector();
...
protected:
    ...
    bool maxMuons_cut;
    int  maxMuons;
    bool minLooseMuons_cut;
    int  minLooseMuons;
    bool maxLooseMuons_cut;
    int  maxLooseMuons;
    bool maxElectrons_cut;
    int  maxElectrons;
    bool minLooseElectrons_cut;
    int  minLooseElectrons;
    bool maxLooseElectrons_cut;
    int  maxLooseElectrons;
