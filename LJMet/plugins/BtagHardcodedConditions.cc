...
#include <cmath>
#include "TTT-singleLep/LJMet/interface/BtagHardcodedConditions.h"
...
/*.-----------------------------------------------------------------.
 ...
 \       |                                                     |       /
  ...
  // root://cmseos.fnal.gov//store/user/jmanagan/TTT-singleLep102X_BEffDeepFlav_101819/*.root for DeepJet
